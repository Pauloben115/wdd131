...
document.getElementById("old").onclick = () =>
  displayTemples(temples.filter(t => t.dedicated < 1900), "Old Temples");

document.getElementById("new").onclick = () =>
  displayTemples(temples.filter(t => t.dedicated > 2000), "New Temples");

document.getElementById("large").onclick = () =>
  displayTemples(temples.filter(t => t.area > 90000), "Large Temples");

document.getElementById("small").onclick = () =>
  displayTemples(temples.filter(t => t.area < 10000), "Small Temples");
